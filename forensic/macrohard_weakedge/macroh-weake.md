...
```shell
┌──(kali㉿kali)-[~/mrrobot/forensic/macrohard_weakedge]
└─$ wget https://mercury.picoctf.net/static/d3dd8cd51524d9fafcccd1b7d55f85e7/Forensics%20is%20fun.pptm
--2024-10-09 12:47:36--  https://mercury.picoctf.net/static/d3dd8cd51524d9fafcccd1b7d55f85e7/Forensics%20is%20fun.pptm
...
2024-10-09 12:47:37 (858 KB/s) - ‘Forensics is fun.pptm’ saved [100093/100093]

                                                                                                                             
┌──(kali㉿kali)-[~/mrrobot/forensic/macrohard_weakedge]
└─$ ls                   
'Forensics is fun.pptm'   macroh-weake.md
...
┌──(kali㉿kali)-[~/mrrobot/forensic/macrohard_weakedge]
└─$ ls
'Forensics is fun.pptm'  '[Content_Types].xml'   _rels   docProps   macroh-weake.md   ppt
                                                                                                                             
┌──(kali㉿kali)-[~/mrrobot/forensic/macrohard_weakedge]
└─$ cd ppt/slideMasters  
                                                                                                                             
┌──(kali㉿kali)-[~/…/forensic/macrohard_weakedge/ppt/slideMasters]
└─$ ls
